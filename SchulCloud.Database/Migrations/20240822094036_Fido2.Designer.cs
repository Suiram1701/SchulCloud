...
namespace SchulCloud.Database.Migrations
{
    ...
    [Migration("20240822094036_Fido2")]
    partial class Fido2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SchulCloud.Database.Models.Fido2Credential", b =>
                {
                    ...
                    b.Property<bool>("IsUsernameless")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("SchulCloud.Database.Models.Fido2Credential", b =>
                {
                    ...
                    b.OwnsMany("SchulCloud.Database.Models.Fido2PublicDeviceKey", "DevicePublicKeys", b1 =>
                        {
                            ...
                            b1.Property<byte[]>("PublicDeviceKey")
                                .IsRequired()
                                .HasColumnType("bytea");

                            b1.HasKey("CredentialId", "Id");

                            b1.ToTable("AspNetCredentialDeviceKeys", (string)null);
