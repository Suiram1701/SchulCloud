    ...
    where TUser : class
{
    ...
    public Task SetPermissionLevel(TUser user, string permissionName, PermissionLevel level, CancellationToken ct);
    ...
    public Task<PermissionLevel> GetPermissionLevel(TUser user, string permissionName, CancellationToken ct);
}
